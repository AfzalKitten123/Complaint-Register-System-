...
import com.echo.complaintsystem.Adapters.IndividualRListAdapter;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<complaintArray.length();i++){
                                complaintList.add(new IndividualR_CLEntry(complaintArray.getJSONObject(i).getString("complaint"), complaintArray.getJSONObject(i).getString("created On")));
                            }
